from REPO.persons_rep import PersonsREP
from flask import jsonify

class PersonsBL():
    def __init__(self) -> None:
        self.persons_rep = PersonsREP()

    def get_all_persons(self):
        return jsonify(self.persons_rep.get_all_persons())
    
    def get_person_by_id(self, id):
        persons = self.persons_rep.get_all_persons()
    ...
    def add_new_person(self, obj):
        persons = self.persons_rep.get_all_persons()
        persons.append(obj)
        self.persons_rep.save_persons(persons)
    ...
    def delete_persons(self, id):
        ...
        self.persons_rep.save_persons(new_persons)
